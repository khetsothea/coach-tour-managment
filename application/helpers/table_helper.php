...
function get_people_manage_table_data_rows($people,$controller)
{
	...
	{
		$table_data_rows.="<tr><td colspan='6'><div class='warning_message' style='padding:7px;'>".$CI->lang->line('no drivers_to_display')."</div></tr></tr>";
	}
...
function get_person_data_row($person,$controller)
{
	...
	$table_data_row='<tr>';
	$table_data_row.="<td ><input type='checkbox' id='person_$person->driver_ID' value='".$person->driver_ID."'/></td>";
	$table_data_row.='<td >'.$person->driver_ID.'</td>';
	$table_data_row.='<td >'.$person->name.'</td>';
	$table_data_row.='<td >'.$person->route_ID.'</td>';
	$table_data_row.='<td >'.$person->num.'</td>';
	$table_data_row.='<td >'.$person->street.'</td>';
	$table_data_row.='<td >'.$person->city.'</td>';
	$table_data_row.='<td >'.$person->telephonNum.'</td>';		
