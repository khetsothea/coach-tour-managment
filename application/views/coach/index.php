...
<div id="title_bar">
	<div id="title" class="float_left">Coach Details</div>
	<div id="new_button">
		<a href="http://localhost/app/index.php/coach/newCoach/" class="thickbox none" title="New Coach">
		<div class="big_button" style="float: left;"><span>New Coach</span></div></a></div>
</div>
...
<th width="11%">Coach ID</th>
<th width="16%">Capacity</th>
<th width="12%">Date of Last use</th>
<th width="11%">Mileage(km)</th>

<th width="11%">&nbsp;</th></tr>
<?php foreach ($coach as $row): ?>

<tr>
<td><input type="checkbox" name="idd[]" value="<?php echo $row['coach_ID'] ?>" ></td>
<td><?php echo $row['coach_ID'];?></td>
<td><?php echo $row['capacity'];?></td>
<td><?php echo $row['date_of_last_service'];?></td>
