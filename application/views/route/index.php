...
<div id="title_bar">
	<div id="title" class="float_left">Route Details</div>
	<div id="new_button">
		<a href="http://localhost/app/index.php/route/newRoute" class="thickbox none" title="New Route">
		<div class="big_button" style="float: left;"><span>New Route</span></div></a></div>
</div>
...
<th width="70%">Town List</th>

<th width="11%">&nbsp;</th></tr>
<?php foreach ($route as $row): ?>

<tr>
<td><input type="checkbox" name="idd[]" value="<?php echo $row['route_ID'] ?>" ></td>
