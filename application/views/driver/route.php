<p><?php echo validation_errors(); ?>
  ...
  <?php echo form_open('driver/route/') ?>
...
<div id="title_bar">
	<div id="title" class="float_left">ADD Route to ID<?php echo $driver_id?> Driver </div>
	
</div>
<div id="table_action_header">
	<ul>
		<li class="float_left"><span><a href="http://localhost/app/index.php/driver/addRoute/<?php echo $driver_id ?>" id="saveroute">Save Route</a></span></li>
...
<th width="15%">Town List</th>

<th width="11%">&nbsp;</th></tr>
<?php foreach ($route as $row): ?>

<tr>
<td><input type="checkbox" id="routeid" name="routeid[]" value="<?php echo $row['route_ID']?>" ></td>
<td><?php echo $row['route_ID'];?></td>
<td><?php echo $row['distance'];?></td>
<td><?php echo $route_towns[$row['route_ID']];?></td>
...
<input class="big_button" type="submit" name="submit" value="Create news item" /> 
